 ...
 * @author YangHaoyan
 */
public class CertificateOrganizationServlet extends HttpServlet {
	// 构造方法
	public CertificateOrganizationServlet() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (user_id == null || certificate_type == null)
			...
			JSONObject obj = dao.queryOrganization(Integer.parseInt(certificate_type));
			out.print(obj);
		}
		out.flush();
		out.close();
