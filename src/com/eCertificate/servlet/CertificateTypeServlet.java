 ...
 * @author YangHaoyan
 */
public class CertificateTypeServlet extends HttpServlet {
	// 构造方法
	public CertificateTypeServlet() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String certificate_type = request.getParameter("certificate_class");
		// 查询证件类型
		if (user_id == null || certificate_type == null)
			out.print("failed");
		else {
			JSONObject obj = dao.queryType(certificate_type);
			out.print(obj);
		}
		out.flush();
		out.close();
