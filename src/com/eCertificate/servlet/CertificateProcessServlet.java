 ...
 * @author YangHaoyan
 */
public class CertificateProcessServlet extends HttpServlet {
	// 构造方法
	public CertificateProcessServlet() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (user_id == null || certificate_type == null)
			...
			JSONObject obj = dao.queryProcess(Integer.parseInt(certificate_type));
			out.print(obj);
		}
		out.flush();
		out.close();
