 ...
 * @author YangHaoyan
 */
public class CertificateMaterialsServlet extends HttpServlet {
	// 构造方法
	public CertificateMaterialsServlet() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (user_id == null || certificate_type == null)
			...
			JSONObject obj = dao.queryMaterials(Integer.parseInt(certificate_type));
			out.print(obj);
		}
		out.flush();
		out.close();
